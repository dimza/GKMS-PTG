          ...
          <div class="panel panel-default plain">
            ...
            <div class=panel-body>
              <form class="form-horizontal" role="form" action="sys/engine/uProfile.php" method="post" enctype="multipart/form-data" id=validate>
                <div class="form-group">
                  <label class="col-sm-2 text-left" style="margin-bottom:3px;">Employee Id</label>
                  ...
                  <div class="col-lg-2 col-sm-2">
                    <input class=form-control disabled value="<?PHP echo $np; ?>">
                  </div>
                  <div class="col-lg-2 col-sm-2">
                    <select class="form-control select2" name="sex">
                      <option value="0"><?PHP echo $sex2; ?></option>
                ...
                <br>
                <div class="form-group">
                  <label class="col-sm-4 text-left" style="margin-bottom:3px;">Status</label>
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <select class="form-control select2" name="stat" disabled>
                      <option value="<?php echo $uStat; ?>"><?php echo $uStat2; ?></option>
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <select class="form-control select2" name="lvl" disabled>
                      <option value="<?php echo $elvl; ?>"><?php echo $elvl2; ?></option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <?PHP $qep= mysql_query("SELECT * FROM emppos ORDER BY descr ASC");
                            ...
                            echo '<select class="form-control select2" name="pos" disabled>';
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <select class="form-control select2" name="boc" disabled>
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <select class="form-control select2" name="drc" disabled>
                      <option value="0">None</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <?PHP $qdv= mysql_query("select * from empdiv where vis=0 AND idEmp=0 ORDER BY code ASC");
                            ...
                            echo '<select class="form-control select2" name="div" disabled>';
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <?PHP $qcat= mysql_query("SELECT * FROM empdep WHERE vis=0 ORDER BY code ASC");
                            ...
                            echo '<select class="form-control select2" name="dep" disabled>';
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <?PHP $qcat= mysql_query("select * from empsec where vis=0 order by descr asc");
                            ...
                            echo '<select class="form-control select2" name="sec" disabled>';
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <?PHP $qcat= mysql_query("select * from kpicat order by idCat asc");
                            ...
                            echo '<select class="form-control select2" name="spv" disabled>';
