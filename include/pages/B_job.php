        ...
        <div class="col-lg-12 col-md-12">
          <!-- Start col-lg-6 -->
            <div class="page-header">
                ...
                <h4>Table list of Job Title Property</h4>
            </div>
        </div>
      </div>
      <!-- End .row -->
              ...
              <table class="table display" id=datatable>
                ...
                <tbody>
                    <?PHP 
                        ...
                        $epQ= mysql_query("SELECT * FROM emppos ORDER BY idPos ASC");
		
						      While ($epQ2= mysql_fetch_assoc($epQ)) 
                              
                              {
								...
								echo '<td><a href="_addUnit.php?sw=1&&kd='.$epQ2['idPos'].'" target="_Blank">'.$epQ2['descr'];
                                echo '<td>'.$epQ2['idEmp'];                                
                                echo '<td>'.$epQ2['mDate'];
                                echo '<td class="text-center"><a href="editKpi.php?kd='.$epQ2["idPo"].'" target="_Blank"><i class="fa-edit s16"></i></a>';
