        ...
        <div class="col-lg-12 col-md-12">
          <!-- Start col-lg-6 -->
            <div class="page-header">
                ...
                <h4>Table list of Unit Property</h4>
            </div>
        </div>
      </div>
      <!-- End .row -->
              ...
              <table class="table display" id=datatable>
                ...
                <tbody>
                    <?PHP 
                        ...
                        $kuQ= mysql_query("SELECT * FROM kpiunit ORDER BY idUnit ASC");
		
						      While ($kuQ2= mysql_fetch_assoc($kuQ)) 
                              
                              {
								...
								echo '<td><a href="_addUnit.php?sw=1&&kd='.$kuQ2['idUnit'].'" target="_Blank">'.$kuQ2['description'];
                                echo '<td>'.$kuQ2['symbol'];
                                echo '<td>'.$kuQ2['idEmp'];                                
                                echo '<td>'.$kuQ2['mDate'];
