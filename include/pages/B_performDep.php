<?PHP
    ...
    $qdv= mysql_query("SELECT * FROM empdep WHERE idDep='$q'") or die(mysql_error());
  ...
  <div class="content-wrapper">
    <div class=outlet>
      ...
      <div class=row>
              ...
              <table class="table display" id="datatable3">
                <thead>
                  <tr>
                    ...
                    <th>Last Activities
                <tbody>                   
                  <?PHP $kc= mysql_query("SELECT * FROM kpidetindv WHERE year='$yr' AND vis='0' AND idDep='$q' ORDER BY code ASC");
        ...
        <!-- col-lg-12 end here -->        
        <?PHP list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM empsec WHERE idDep='$q'")); if ($lg=="0") { } else { ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <!-- col-lg-12 start here -->
          <div class=page-header>
            <h4>Section</h4>
        ...
        <!-- col-lg-12 end here -->
        <?PHP } ?>
        <?PHP $ed= mysql_query("SELECT * FROM empsec WHERE idDep='$q' AND vis=0");
        
                    While ($ed2= mysql_fetch_assoc($ed)) {

                        echo '<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">';
                        echo '<div class="tile-stats b brall mb25"><a href="_performSec.php?kd='.$ed2['idSec'].'">';
