        ...
        <div class="col-lg-12 col-md-12">
          <!-- Start col-lg-6 -->
            <div class="page-header">
                ...
                <h4>Table list of Division Property</h4>
            </div>
        </div>
      </div>
      <!-- End .row -->
              ...
              <table class="table display" id=datatable>
                ...
                <tbody>
                    <?PHP 
                        ...
                        $edvQ= mysql_query("SELECT * FROM empdiv ORDER BY idDiv ASC");
		
						      While ($edvQ2= mysql_fetch_assoc($edvQ)) 
                              
                              {
                                ...
                                echo '<td>'.$edvQ2['code'];
                                echo '<td>'.$edvQ2['code2'];
								echo '<td><a href="_add.php?sw=1&&kd='.$edvQ2['idDiv'].'" target="_Blank">'.$edvQ2['descr'];
                                echo '<td>'.$edvQ2['icon'];
                                echo '<td>'.$edvQ2['spc'];
                                echo '<td>'.$edvQ2['vis'];
                                echo '<td>'.$edvQ2['mEmp'];                                
                                echo '<td>'.$edvQ2['mDate'];
                                echo '<td class="text-center"><a href="edit.php?kd='.$edvQ2["idDiv"].'" target="_Blank"><i class="fa-edit s16"></i></a>';
