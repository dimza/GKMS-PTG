      ...
      <div class=row>
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="panel panel-default plain panel-closed toggle showControls">
            <!-- Start .panel -->
            <div class="panel-heading white-bg">
                <h4 class=panel-title><h5>Key Performance Indicators</h5></h4>        
            </div>
            <div class=panel-body>
                  ...
                  <?PHP $kc= mysql_query("SELECT * FROM kpidetindv WHERE year='$yr' AND vis='0' AND idDiv='$q' ORDER BY code ASC");
                          ...
                          While ($kc2= mysql_fetch_assoc($kc)) {
                            ...
                            $qi=$kc2['idKpiDetIndv'];
                                            ...
                                            echo '<td>'.$kc2['code'];
                                            echo '<td><a href="_viewKpi3.php?kd='.$kc2["idKpiDetIndv"].'&&mtr='.$kc2['idMont'].'" target="_Blank">'.$kc2['title'].'</a>';
        ...
        <!-- col-lg-12 end here -->
        <?PHP $ed= mysql_query("SELECT * FROM empdiv WHERE code2='$i' AND spc=4");
        ...
        <?PHP list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM empdep WHERE idDiv='$q'")); if ($lg=="0") { } else { ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <!-- col-lg-12 start here -->
          <div class=page-header>
            <h4>Department</h4>
