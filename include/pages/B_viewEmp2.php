    ...
    <div class=outlet>
      ...
      <div class=row>
        <div class="col-lg-8 col-md-8">
            ...
            <?PHP list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM kpidetindv WHERE idEmp='$var'")); if ($lg=="0") { ?>
            ...
            <?PHP list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM kpidetindv WHERE idCat='1' AND idEmp='$var'")); if ($lg=="0") { } else { ?>            
                <div class="panel panel-default plain toggle panelRefresh">
                    ...
                    <div class="panel-heading white-bg">
                        ...
                        <h4 class=panel-title><i class=en><img class=user-avatar src=assets/img/<?PHP echo $imgs; ?>></i> 
                            <h5 style="margin-top:10px;">FINANCE</h5>Weight Perspective: <?PHP echo $qcat2; ?>%
                        </h4>
                    </div>
            ...
            <?PHP } list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM kpidetindv where idCat='2' and idEmp='$var'")); if ($lg=="0") { } else { ?>                
                <div class="panel panel-default plain toggle panelRefresh">
                    <!-- Start .panel -->
                    <div class="panel-heading white-bg min">
					   <?PHP $kc= mysql_query("SELECT * FROM kpidetindv WHERE idCat='2' AND year='$yr' AND vis='0' AND idEmp='$var' ORDER BY code ASC");
                        ...
                        ?>                
                        <h4 class=panel-title><i class=en><img class=user-avatar src=assets/img/<?PHP echo $imgs; ?> ></i> 
                            <h5 style="margin-top:10px;">STAKEHOLDERS</h5>Weight Perspective: <?PHP echo $qcat6; ?>%
                        </h4>
                    </div>
                    <div class=panel-body>
            ...
            <?PHP } list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM kpidetindv where idCat='3' and idEmp='$var'")); if ($lg=="0") { } else { ?>                
                <div class="panel panel-default plain toggle panelRefresh">
                    <!-- Start .panel -->
                    <div class="panel-heading white-bg min">
                ...
                <!-- End .panel -->
            <?PHP } list($lg)=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM kpidetindv WHERE idCat='4' AND idEmp='$var'")); if ($lg=="0") { } else { ?>
                <div class="panel panel-default plain toggle panelRefresh">
                    <!-- Start .panel -->
                        <div class="panel-heading white-bg min">
                            ...
                            ?>
                            <h4 class=panel-title><i class=en><img class=user-avatar src=assets/img/<?PHP echo $imgs; ?> ></i> 
                                <h5 style="margin-top:10px;">LEARNING & GROWTH</h5>Weight Perspective: <?PHP echo $qcat10; ?>%
                            </h4>
                        </div>
                        <div class=panel-body>
