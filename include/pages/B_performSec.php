<?PHP
    ...
    $qdv= mysql_query("SELECT * FROM empsec WHERE idSec='$q'") or die(mysql_error());
    $qdv2= mysql_result($qdv, 0, 'descr');
    $qdv3= mysql_result($qdv, 0, 'code');
              ...
              <table class="table display" id="datatable3">
                <thead>
                  <tr>
                    ...
                    <th>Last Activities
                <tbody>                   
                  <?PHP $kc= mysql_query("SELECT * FROM kpidetindv WHERE year='$yr' AND vis='0' AND idSec='$q' ORDER BY code ASC");
