        ...
        <div class="col-lg-12 col-md-12">
          <!-- Start col-lg-6 -->
            <div class="page-header">
                ...
                <h4>Table list of Section Property</h4>
            </div>
        </div>
      </div>
      <!-- End .row -->
              ...
              <table class="table display" id=datatable>
                ...
                <tbody>
                    <?PHP 
                        ...
                        $esQ= mysql_query("SELECT * FROM empsec ORDER BY idSec ASC");
		
						      While ($esQ2= mysql_fetch_assoc($esQ)) 
                              
                              {
                                ...
                                echo '<td>'.$esQ2['idDep'];
                                echo '<td>'.$esQ2['code'];
								echo '<td><a href="_add.php?sw=1&&kd='.$esQ2['idSec'].'" target="_Blank">'.$esQ2['descr'];
                                echo '<td>'.$esQ2['idEmp'];                                
                                echo '<td>'.$esQ2['mDate'];
                                echo '<td class="text-center"><a href="edit.php?kd='.$esQ2["idSec"].'" target="_Blank"><i class="fa-edit s16"></i></a>';
