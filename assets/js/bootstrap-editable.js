...
(function ($) {
    ...
    */      
    ...
    '<div><div class="editable-input" style="margin-bottom:5px;"></div><div class="editable-buttons" align="right"></div></div>'+
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="editable-submit" style="margin-right:5px;">ok</button>'+
...
(function ($) {
    ...
    $.fn.editableform.buttons = 
      '<button type="submit" class="btn btn-primary btn-sm editable-submit" style="margin-right:5px;">'+
        'ADD '+
      '</button>'+
